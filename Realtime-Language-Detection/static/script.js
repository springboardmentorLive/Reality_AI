...
function resetResultUI() {
    // विश्लेषण शुरू करने से पहले परिणाम क्षेत्रों को साफ करें
...
function updateResultUI(data) {
    // सफल API कॉल के बाद परिणाम भरें
...
function updateStatus(className, message, isRecording = false) {
    ...
    // केवल लाइव मोड में विज़ुअलाइज़र को नियंत्रित करें
...
// --- 3. File Upload Logic (नया) ---

fileInput.addEventListener('change', () => {
    // फ़ाइल चुनने पर अपलोड बटन को सक्षम करें
...
modeBtns.forEach(btn => {
    btn.addEventListener('click', () => {
        ...
        // सभी बटन से 'active' हटाएँ
        modeBtns.forEach(b => b.classList.remove('active'));
        // वर्तमान बटन को 'active' करें
        ...
        // मोड बदलने पर स्थिति संदेश रीसेट करें
...
// पेज लोड होने पर हिस्ट्री लोड करें
